...
export const tools: ToolDefinition[] = [
  ...
  {
    id: "inss-irrf",
    title: "Calculadora de INSS e IRRF",
    description: "Estime descontos mensais de INSS e IRRF com tabelas 2026, bases e memória de cálculo.",
    href: "/calculadoras/inss-irrf",
    icon: Landmark,
    available: true,
    familyId: "calculadoras",
    primaryCategoryId: "trabalho-salario-beneficios",
  ...
  },
  {
    ...
    description: "Converta salário bruto mensal em valor da hora, divisor 220, jornada semanal ou divisor manual.",
    href: "/calculadoras/salario-por-hora",
    icon: Clock,
    available: true,
    familyId: "calculadoras",
    primaryCategoryId: "trabalho-salario-beneficios",
  ...
  {
    id: "inss-em-atraso",
    title: "Calculadora de INSS em Atraso",
    description: "Estime multa, juros Selic e total de uma contribuição INSS/GPS em atraso sobre valor original informado.",
    href: "/calculadoras/inss-em-atraso",
    icon: Landmark,
    available: true,
    familyId: "calculadoras",
    primaryCategoryId: "impostos-governo",
  ...
  {
    id: "financiar-ou-juntar-dinheiro",
    title: "Financiar ou juntar dinheiro para comprar imóvel?",
    description: "Compare financiar agora com juntar e investir até conseguir pagar um imóvel à vista.",
    href: "/calculadoras/financiar-ou-juntar-dinheiro",
    icon: Scale,
    available: true,
    familyId: "calculadoras",
    primaryCategoryId: "moradia-patrimonio",
    categoryIds: ["moradia-patrimonio", "financiamento-credito", "investimentos-rendimentos"],
    sitemapPriority: 0.82,
    stateMode: "query",
    seoApplicationCategory: "FinanceApplication",
  },
  {
    id: "correcao-igpm",
    title: "Calculadora IGP-M",
    description: "Corrija pelo IGP-M oficial o valor pago por um imóvel entre meses selecionados.",
    href: "/calculadoras/correcao-igpm",
    icon: TrendingUp,
    available: true,
    familyId: "calculadoras",
    primaryCategoryId: "moradia-patrimonio",
  ...
  {
    id: "investimento-cdi",
    title: "Calculadora Investimento CDI",
    description: "Calcule rendimento bruto e líquido a 100%, 110% ou outro percentual do CDI com snapshot BCB.",
  ...
  {
    id: "conversor-csv-json",
    title: "Conversor CSV JSON",
    description: "Converta CSV para JSON e JSON para CSV no navegador, com delimitador, cabecalhos e preview.",
    href: "/dev/conversor-csv-json",
    icon: Braces,
    available: true,
    familyId: "dev",
    primaryCategoryId: "dados-estruturados",
  ...
  },
  {
    ...
    description: "Confira localmente se PIS, PASEP, NIS ou NIT tem 11 dígitos e checksum plausível.",
    href: "/validadores/validador-pis-pasep",
    icon: Fingerprint,
    available: true,
    familyId: "validadores",
    primaryCategoryId: "documentos",
