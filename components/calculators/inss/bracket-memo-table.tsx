...
interface BracketMemoTableProps {
...
export function BracketMemoTable({ slices }: BracketMemoTableProps) {
  const t = useTranslations("calculators.inss.brackets");
    ...
    <Card>
      ...
      <CardContent className="p-0 sm:p-6">
        <div className="-mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0">
          <Table className="min-w-[620px]" data-testid="inss-bracket-table">
            <TableHeader>
              <TableRow>
