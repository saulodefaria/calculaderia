...
import type {
  SalarioLiquidoBreakdownCategory,
  SalarioLiquidoBreakdownRow,
} from "@/lib/calculators/salario-liquido";

interface BreakdownTableProps {
  rows: SalarioLiquidoBreakdownRow[];
}

const CATEGORY_ORDER: SalarioLiquidoBreakdownCategory[] = [
  "proventos",
  "descontosLegais",
  "descontosManuais",
  "liquido",
...
export function BreakdownTable({ rows }: BreakdownTableProps) {
  const t = useTranslations("calculators.salario-liquido.breakdown");

  const renderDetail = (row: SalarioLiquidoBreakdownRow) => {
