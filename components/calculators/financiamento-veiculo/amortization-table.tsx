...
import type { FinanciamentoVeiculoParcela } from "@/lib/calculators/financiamento-veiculo";
...
export function AmortizationTable({ parcelas }: AmortizationTableProps) {
  const t = useTranslations("calculators.financiamento-veiculo.table");
    ...
    <Card>
      ...
      <CardContent className="p-0 sm:p-6">
        <div className="-mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0">
          <Table className="min-w-[700px]" data-testid="financiamento-veiculo-amortization-table">
            <TableHeader>
              <TableRow>
