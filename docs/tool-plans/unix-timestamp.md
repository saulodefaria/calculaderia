...
- Validation results:
  ...
  - `DATABASE_URL='postgresql://postgres:postgres@localhost:5433/calculaderia?schema=public' ./node_modules/.bin/prisma generate`: passed for local validation.
  ...
  - `NEXT_TELEMETRY_DISABLED=1 DATABASE_URL='postgresql://postgres:postgres@localhost:5433/calculaderia?schema=public' AUTH_SECRET=build-check-secret AUTH_URL=http://localhost:3100 NEXTAUTH_URL=http://localhost:3100 ./node_modules/.bin/next build`: passed after the `blocking(date-input)` fix.
