...
export default async function CalculadoraFinanceiraOnlinePage() {
  const locale = await getLocale();
  const t = await getTranslations("calculators.calculadora-financeira-online");
  const tCommon = await getTranslations("common");
  const tCategories = await getTranslations("calculatorCategories");
  const tNav = await getTranslations("nav");
  const tSeo = await getTranslations("calculators.calculadora-financeira-online.seo");
