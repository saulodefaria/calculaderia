...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: getAlternateLanguagePathnames("/calculadoras/financiamento-minha-casa-minha-vida"),
    },
    openGraph: {
      title,
      description,
...
export default async function FinanciamentoMinhaCasaMinhaVidaLayout({
  children,
  params,
}: {
