...
export default async function FinanciamentoPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const tSeo = await getTranslations({ locale, namespace: "calculators.financiamento.seo" });
